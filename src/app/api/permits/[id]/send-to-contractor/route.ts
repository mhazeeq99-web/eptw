...
export async function POST(
  ...
  try {
    ...
    // Update permit to sent to contractor
    ...
    if (updateError) {
      console.error('Error sending to contractor:', updateError)
    ...
    const { error: historyError } = await supabase
      ...
      .insert({
        ...
        remarks: 'Permit sent to contractor for review',
      })
    ...
    console.error('Error in send-to-contractor:', error)
