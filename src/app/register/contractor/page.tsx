          ...
          <div className="space-y-6 text-center">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-600 dark:text-gray-400">
                Your contractor account has been created. Save your company code for future reference.
              </p>
            </div>
      ...
      <div className="relative w-full max-w-3xl">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-xl shadow-gray-200/50 dark:border-gray-700 dark:bg-gray-900 dark:shadow-gray-900/50">
          <div className="mb-8">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              Create your contractor account to submit permits for authorized customer companies.
            </p>
          </div>
